...
<html>
    <head>
        <title>Web Dev Club - Code Editor</title>
        <meta charset="UTF-8">
    ...
    <body>
        ...
        <div id="title0_1" class="codeEditorTitle"> 
            <h1> HTML/CSS/JS Code Editor </h1>
        </div>
        <div class = "canvas" style="overflow-x:auto;">

            <div id = "TheCodeEditor" style='width:100%;'>

            </div>
        </div>
        <script>
            $("#TheCodeEditor").load("codeeditor.php");
        </script>
        <footer id="footer">
            <h1> Web Dev Club </h1>
            <br><br>
